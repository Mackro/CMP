...
public class Armageddon extends Spell {
	...
	private final static String DESCRIPTION = "Destroy 5 troops in each territory on the map to a minium of 1, and 1 additional damage next turn \n \n \"That's it! \" ";

	private final static String NAME = "Armageddon";
